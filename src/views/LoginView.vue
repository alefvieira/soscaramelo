                    ...
                    <v-row>
                        <v-col cols="12">
                            <label>
                              ...
                              <v-text-field solo v-model="usuario.usuario" label="Informe Usuário ou E-mail" prepend-inner-icon="mdi-account" required></v-text-field>
                            </label> 

                            <label>
                              <legend>Senha:</legend>
                              <v-text-field type="password" v-model="usuario.senha" solo label="Informe a senha" prepend-inner-icon="mdi-lock" required></v-text-field>
                            </label>
                        </v-col>
                    </v-row>
                    <v-row>
                        <v-col cols="12">
                              <v-btn class="botao-01" @click="salvarUsuario">ACESSAR</v-btn>
