            ...
            <v-col offset-lg="2" lg="8" md="12">
                <v-form v-model="valid">
                  <div class="input-form">
                    <v-row>
                        <v-col cols="12">
                            <label>
                              ...
                              <v-text-field solo v-model="usuario.email" label="Informe Usuário ou E-mail" prepend-inner-icon="mdi-account" required></v-text-field>
                            </label> 

                            <label>
                              <legend>Senha:</legend>
                              <v-text-field type="password" v-model="usuario.password" solo label="Informe a senha" prepend-inner-icon="mdi-lock" required></v-text-field>
                            </label>
                        </v-col>
                    </v-row>
                    <v-row>
                    ...
                    <v-row>
                        <v-col cols="12">
                              <v-btn class="botao-01" @click="autenticarUsuario">ACESSAR</v-btn>
                                                            
                              <div class="bloco-texto-inscreva">
                                <p class="font-legenda">Não tem conta? <v-btn to="/cadastrar" text> Inscreva-se</v-btn></p>
                              </div>
                        </v-col>
                    </v-row>
                  </div>
