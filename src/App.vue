<template>
  <!-- cria a tela de aplicação vuetify -->
  <v-app >
  <!-- cria a barra de aplicação vuetify -->
    <v-app-bar
      app
      color="primary"
      dark
    ...
    <v-main style="padding: 0;background-color: #ffee1f;">
      <router-view/>
    </v-main>
    <Footer>
    </Footer>
...
<style>
  *{
  ...
  @font-face{
    font-family: "Macondo Swash Cap";
    src: url('./assets/fonts/macondo/MacondoSwashCaps-Regular.ttf') format('truetype');
    font-weight: normal;
    font-style: normal;
    /* tipo de formatos 
    - opentype (otf)
